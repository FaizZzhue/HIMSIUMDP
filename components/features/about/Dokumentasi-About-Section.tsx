...
export default function DokumentasiAboutSection() {
    const GALLERY: GalleryItem[] = [
        ...
        },
        {
            ...
            title: "Safari Ormawa",
            proker: "",
            purpose: "Sharing & Evaluasi antar ormawa untuk meningkatkan sinergi dan kolaborasi di lingkungan kampus.",
        },
        {
            ...
            proker: "",
            purpose: "Meningkatkan semangat persaingan dan keterampilan mahasiswa melalui berbagai lomba dan kompetisi.",
        },
        {
            ...
            purpose: "Menyelenggarakan acara diskusi dan pembahasan topik-topik menarik dalam dunia sistem informasi.",
        },
    ];
