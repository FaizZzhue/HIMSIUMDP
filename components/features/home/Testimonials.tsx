    ...
    <section className="relative w-full overflow-hidden py-20 sm:py-24">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1240px] px-5 sm:px-7 lg:px-10">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3">
          <MarqueeColumn items={firstColumn} duration={18} offset={0} />
          <MarqueeColumn items={secondColumn} duration={22} offset={-120} />
          <MarqueeColumn items={thirdColumn} duration={20} offset={-60} />
        </div>
      </div>
    </section>
  );
