            ...
            <div className="relative z-10 mx-auto min-h-screen w-full max-w-[1480px] px-6 pb-16 pt-24 sm:px-10 lg:px-12 lg:pb-24 lg:pt-28 xl:pt-30">
                <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
                    <div className="max-w-[680px]">
                        ...
                        >
                            <Button className="
                                    h-12 rounded-full px-9 text-white bg-[#0A3763] hover:bg-[#0A3763]/90 dark:bg-[#2464A8] dark:hover:bg-[#2464A8]/90"
                                asChild
                            >
                            ...
                            <Button
                                variant="outline"
                                className="
                                    h-12 rounded-full px-9 border border-black/10 bg-white/70 text-[#071227] hover:bg-white/85dark:border-white/35 dark:bg-white/10 dark:text-white dark:hover:bg-white/15
                                "
                            >
