...
export default function Pengurus({
  ...
  const people = useMemo<Person[]>(() => {
    ...
    const source =
      viewMode === "staff"
        ? (bidang.divisions ?? []).flatMap((division) => division.members ?? [])
        ...
        {!bidang ? (
          ...
          <>
            <div className="flex flex-col gap-10 lg:flex-row lg:items-stretch">
              <div className="flex min-h-[320px] w-full flex-col items-center justify-center text-center lg:min-h-[740px] lg:w-[40%] lg:items-start lg:justify-center lg:text-left">
                <div>
              ...
              <div className="relative min-h-[560px] w-full overflow-visible sm:min-h-[680px] lg:min-h-[740px] lg:w-[60%]">
                {people.length ? (
                  <div className="absolute inset-0 flex items-center justify-center lg:justify-end">
                    <div
                      className={[
                        "relative pointer-events-none",
                        "aspect-square w-[min(92vw,520px)]",
                        ...
                        <AnimatePresence mode="wait">
                          ...
                          >
                            ...
                            <div className="mt-6 text-center">
                              <h4 className="text-xl font-black tracking-tight text-[#0A3763] dark:text-[#D3A32D] md:text-2xl">
                                {activePerson?.name ?? "Nama Anggota"}
                              </h4>
                              <p className="mt-1 text-sm font-bold uppercase tracking-widest text-[#2464A8] dark:text-slate-400 md:text-base">
            ...
            {hasProgramKerja ? (
              <div className="mt-4">
                <h4 className="text-4xl text-center font-semibold tracking-tight text-[#0A3763] dark:text-[#2464A8] sm:text-5xl">
                  Program Kerja 
                  <span className="text-[#D3A32D]"> {bidang.name}</span>
                </h4>
                <div className="mt-8 glass-card rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm sm:p-7">
