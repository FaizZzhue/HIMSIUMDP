...
export default function AboutSection() {
  return (
    <section id="about" className="relative overflow-hidden bg-himsi-about">
        {/* <div
            aria-hidden
            className="pointer-events-none absolute bottom-0 left-0 h-24 w-full bg-gradient-to-b from-transparent via-white/30 to-white"
        /> */}
      ...
      <div className="relative z-10 mx-auto w-full max-w-[1320px] px-5 py-20 sm:px-7 lg:px-10 lg:py-24">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <motion.div
            ...
            className="inline-flex items-center justify-center rounded-full bg-[#D3A32D] px-6 py-2 text-sm font-semibold text-white shadow-[0_10px_40px_rgba(211,163,45,0.25)]"
          >
            About Us
          </motion.div>
        ...
        <div className="relative mt-14 h-[420px] w-full">
          ...
          >
            <Image
              ...
              priority={false}
            />
            {/* soft overlay supaya menyatu dengan gradient */}
            <div className="absolute inset-0 bg-white/15" />
          </div>

          {/* Glass Stats Card (kanan bawah) */}
          <motion.div
      ...
      {/* Fade bawah (biar rapi nyambung ke section selanjutnya) */}
      <div
        aria-hidden
        className="pointer-events-none absolute bottom-0 left-0 h-24 w-full bg-gradient-to-b from-transparent to-white/80"
      />
    </section>
  );
}
